...
document.querySelector('#piclocNewpanel  form').addEventListener('submit', onSubmitHandler);
document.querySelector('#picuserNewpanel  form').addEventListener('submit', onSubmitHandler);
